...
export const walletsTable = pgTable("wallets", {
  ...
  balanceNexa: numeric("balance_nexa", { precision: 30, scale: 8 }).notNull().default("10.00000000"),
  balanceBtc: numeric("balance_btc", { precision: 30, scale: 8 }).notNull().default("0.00100000"),
  balanceEth: numeric("balance_eth", { precision: 30, scale: 8 }).notNull().default("0.05000000"),
